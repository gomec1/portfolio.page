class FooterComponent extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
      <footer class="bg-white pb-5 pt-14 text-center text-black shadow-inner">
        <div class="container mx-auto flex flex-col items-center">
          <p class="mb-6 flex max-w-5xl justify-center rounded-2xl border-2 border-black px-3 text-center">
            <img src="../images/MailIcon.svg" alt="Mail Icon" class="mr-2" />
            <a class="font-sans" href="mailto:carlos@gomezpereanez.com">carlos@gomezpereanez.com</a>
          </p>
          <div class="mb-4 flex justify-center space-x-4">
            <a href="https://www.linkedin.com/in/carlos-a-gomez-p/" target="_blank" class="text-black hover:text-gray-700">
            ...
            <a href="https://github.com/gomec1" target="_blank" class="text-black hover:text-gray-700">
              <svg class="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <p class="mt-10 font-sans text-sm">&copy; 2024 All Rights Reserved</p>
        </div>
      </footer>
      `;
  }
